...
> **ISO 镜像在 [Releases](https://github.com/howe123456/licOS/releases/tag/v2026.07.03) 发布，约 1.5 GB。**

## 快速开始

### 从 ISO 启动

1. 从 [Releases](https://github.com/howe123456/licOS/releases/tag/v2026.07.03) 下载最新 ISO
2. 写入 U 盘：
   ```bash
